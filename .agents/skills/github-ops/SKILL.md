...
Use this skill when working with GitHub issues, PRs, and releases for NextBitDeskify.
...
gh api repos/AquilaWilfred/NextBitDeskify/pulls/456/comments
...
npm view nextbitdeskify-cli version
npm view nextbitdeskify-cli@<version> dist.tarball
```
