...
# Copy project files
COPY . /nextbitdeskify
WORKDIR /nextbitdeskify

# Copy Rust build artifacts
COPY --from=cargo-builder /nextbitdeskify/src-tauri /nextbitdeskify/src-tauri
...
# Install dependencies and build nextbitdeskify-cli
...
WORKDIR /output
ENTRYPOINT ["node", "/nextbitdeskify/dist/cli.js"]
