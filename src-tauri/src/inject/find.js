(function () {
  ...
  const MARK_ATTR = "data-nextbitdeskify-find";
  const ACTIVE_ATTR = "data-nextbitdeskify-find-active";
  const MATCH_HIGHLIGHT = "nextbitdeskify-find-match";
  const ACTIVE_HIGHLIGHT = "nextbitdeskify-find-active";
  ...
  const state = {
    enabled: window.nextbitdeskifyConfig?.enable_find === true,
    panel: null,
    input: null,
    counter: null,
    status: null,
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      #${PANEL_ID} [data-nextbitdeskify-find-counter] {
        flex: 0 0 auto;
        min-width: 42px;
        color: #5f6b7a;
        text-align: center;
      ...
      #${PANEL_ID} [data-nextbitdeskify-find-status] {
        position: absolute;
        left: 10px;
        top: calc(100% + 4px);
        color: #d1242f;
  ...
  function ensurePanel() {
    ...
    counter.setAttribute("data-nextbitdeskify-find-counter", "");
    ...
    status.setAttribute("data-nextbitdeskify-find-status", "");
  ...
  function handleFindShortcut(event) {
    ...
    event.preventDefault();
    event.stopPropagation();
    window.nextbitdeskifyFind[action]();
  }
