...
(function () {
  ...
  function initFullscreenPolyfill() {
    ...
    if (!document.getElementById("nextbitdeskify-fullscreen-style")) {
      const styleEl = document.createElement("style");
      styleEl.id = "nextbitdeskify-fullscreen-style";
      styleEl.textContent = `
      body.nextbitdeskify-fullscreen-active {
        overflow: hidden !important;
      }
      .nextbitdeskify-fullscreen-element {
      ...
      .nextbitdeskify-fullscreen-element video {
        width: 100% !important;
    ...
    function enterFullscreen(element) {
      ...
      targetElement.classList.add("nextbitdeskify-fullscreen-element");
      document.body.classList.add("nextbitdeskify-fullscreen-active");
    ...
    function exitFullscreen() {
      ...
      targetElement.classList.remove("nextbitdeskify-fullscreen-element");
      document.body.classList.remove("nextbitdeskify-fullscreen-active");
