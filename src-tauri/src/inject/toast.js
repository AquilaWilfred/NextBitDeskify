...
// Kept tiny and always loaded so the Rust side can rely on `window.nextbitdeskifyToast`.
document.addEventListener("DOMContentLoaded", () => {
  function nextbitdeskifyToast(msg) {
  ...
  window.nextbitdeskifyToast = nextbitdeskifyToast;
});
